...
class Options:
    ...
    def parse_args(self):
        ...
        parser.add_argument('--target-mesh', type=str, default='./data/giraffe_target.obj', help='input point cloud')
        parser.add_argument('--initial-mesh', type=str, default='./data/giraffe_initsmallmesh.obj', help='initial mesh')
